...
$req = $bdd->prepare("SELECT a.id_article, a.date, a.titre, a.affiche, a.id_cat, c.id_cat, c.nom FROM article a, categorie c WHERE a.id_cat = c.id_cat ");
$req ->execute();
   					...
   					<div class="case">
   						<div class="row">
   							<div class="col-md-6 col-lg-6 col-xl-8 d-flex">
   								<a href="blog-single.php?id=<?php echo $donnees['id_article']; ?>" class="img w-100 mb-3 mb-md-0" style="background-image: url(<?php echo $donnees['affiche']; ?>);"></a>
   							</div>
   							<div class="col-md-6 col-lg-6 col-xl-4 d-flex">
   								<div class="text w-100 pl-md-3">
   									<span class="subheading"><?php echo $donnees['nom']; ?></span>
   									<h2><a href=""blog-single.php?id=<?php echo $donnees['id_article']; ?>""><?php echo $donnees['titre']; ?></a></h2>
			                ...
			                <li class="ftco-animate"><a href="#"><span class="icon-instagram"></span></a></li>
   									...
   									<div class="meta">
   										<p class="mb-0"><a href="#"><?php echo $donnees['date']; ?></a>  </p>
   									</div>
   								</div>
   							</div>
   						</div>
