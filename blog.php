      ...
      <div class="container">
        ...
        <?php
          ...
          <div class="col-md-4 d-flex ftco-animate">
              ...
              <a href="blog-single.php?id=<?php echo $donnees['id_article']; ?>" class="block-20" style="background-image: url('<?php echo $donnees['affiche']; ?>');">
              </a>
              <div class="text p-4 float-right d-block">
              	...
              	<h3 class="heading mb-3"><a href="blog-single.php?id=<?php echo $donnees['id_article']; ?>"><?php echo $donnees['titre']; ?></a></h3>
                <p><?php echo $donnees['descriptif']; ?></p>
                <p><a href="blog-single.php?id=<?php echo $donnees['id_article']; ?>" class="btn-custom"><span class="ion-ios-arrow-round-forward mr-3"></span>Read more</a></p>
              </div>
            </div>
          </div>
          <?php } ?>
