...
$id=$_GET['id'];
$req = $bdd ->prepare("SELECT a.affiche, a.titre, a.texte, a.id_cat, c.id_cat, c.nom
...
$donnees = $req ->fetch(); ?>
          	...
          	<p class="mb-5">
              <img src="<?php echo $donnees['affiche']; ?>" alt="" class="img-fluid">
            </p>
            <h2 class="mb-3"><?php echo $donnees['titre'] ?></h2>
            ...
            <div class="tag-widget post-tag-container mb-5 mt-5">
              <div class="tagcloud">
                <a href="#" class="tag-cloud-link"><?php echo $donnees['nom'] ?></a>
